    ...
    return (
        <div className='mt-20 bg-neutral-900 py-16 text-white'>
            ...
            <div className='grid grid-cols-1 mx-5 md:mx-0 md:grid-cols-4 items-center mt-12 gap-10 justify-center '>
                ...
                {/* card one contents */}
                <div className='flex items-start flex-col bg-neutral-700 px-5 py-10 rounded-2xl'>
                ...
                <button className='btn rounded-full btn-ghost hover:bg-neutral-500'>Learn More<FaArrowRight />
                </button>
                ...
                <h3 className='text-xl my-2'>Innovative and Fun
                </h3>

                <p className='lg w-2/3 mb-4'>Experience faith in a fresh way through our interactive features, engaging events, and modern 
                ...
                <h3 className='text-xl my-2'>Promoting Unity
                </h3>

                <p className='lg w-2/3 mb-4'>We foster understanding and harmony between different faith communities through.
