        ...
        <div className='mt-32'>
            <footer className="py-20 flex flex-wrap justify-around items-start gap-10  bg-[#080810] text-white">
                ...
                <nav className="flex  flex-col gap-2">
                    ...
                    <a className="link link-hover">Leaders</a>
                    <a className="link link-hover">Support</a>
                    <a className="link link-hover">Profile</a>
                </nav>
                <nav className="flex flex-col gap-2">
                    <h6 className="footer-title">Contact</h6>
                    <a className="link link-hover">contact@communionhub.org</a>
                    
                </nav>
            </footer>

            <footer className="py-7 flex flex-wrap justify-around items-start gap-10  bg-[#080810] text-white border-t-2 border-gray-700">
                <aside className="flex mx-5 md:mx-0 text-center items-center gap-2">
